export const graphData = {
  ...
  articles: {
    ...
    'functions': [
      'Отношение $(F)$ &mdash; функция, если $(\\forall x \\in \\op{dom} F \\exists !y: xFy)$.',
      '',
      '<b>&#8227; Пример</b>',
      ...
      '$(F: A \\rightarrow B)$ &mdash; сюръективная функция, если $(\\op{ran} F = B)$.',
    ],
    'injective-rel': [
      'Отношение $(R)$ &mdash; инъективное отношение, если $(\\forall y \\in \\op{ran} R \\exists !x: xFy)$.',
      '',
      '<b>&#8227; Пример</b>',
    ...
    'equiv-rel': [
      ...
      '',
      '<b>Теорема.</b> Если $(R)$ &mdash; симметричное и транзитивное отношение, то $(R)$ &mdash; отношение эквивалентности на $(\\op{fld} R)$.',
    ],
    'equiv-class': [
      '$([x]_R \\coloneqq \\{t \\mid xRt\\})$.',
      'Если $(R)$ &mdash; отношение эквивалентности и $(x \\in \\op{fld} R)$, то $([x]_R)$ &mdash; класс эквивалентности $(x)$ по модулю $(R)$.',
      '',
